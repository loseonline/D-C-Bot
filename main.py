...
def button():
	BUTTON=[[InlineKeyboardButton(text="👨🏻‍💻 Sahibim ",url="t.me/loseonline")]]
	BUTTON+=[[InlineKeyboardButton(text="➕ Beni Bir Guruba Ekle",url="https://t.me/Lose_DC_OyunBot?startgroup=a")]]
...
async def _(client, message):
	...
	await message.reply_text(text="**Merhaba {}!**\n\n__Ben Pyrogram Api İle Yazılmış Sevgili Bot Ustam @loseonline Tarafından Yapılmış Bir Eğlence Botuyum :)__\n\n**\nDoğruluk mu? Cesaret mi? Oyun Komutu => /dc".format(
	...
	if str(user.id) == str(user_id):
		...
		if c_q_d == "d_data":
			...
			await client.delete_messages(
				...
				message_ids=callback_query.message_id) # Eski Mesajı Silelim
